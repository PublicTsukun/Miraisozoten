...
#define	SCORE_SIZE_X		(50.0f*SCREEN_SCALE)							// スコアの数字の幅
#define	SCORE_SIZE_Y		(75.0f*SCREEN_SCALE)						// スコアの数字の高さ
#define	SCORE_INTERVAL_X	(0.0f)							// スコアの数字の表示間隔

#define	NUM_PLACE			(5)							// スコアの桁数 stage.hのMAX_PRICEと桁数合わせること

#define	SCORE_POS_X			(SCREEN_CENTER_X-SCORE_SIZE_X*NUM_PLACE)						// スコアの表示基準位置Ｘ座標
#define	SCORE_POS_Y			(SCORE_SIZE_Y+(5.0f+RESULT_LOGO_SIZE_Y*2)*SCREEN_SCALE)				// スコアの表示基準位置Ｙ座標
