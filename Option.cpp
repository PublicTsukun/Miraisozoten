...
void UpdateOption(void)
{
	...
	{// 感度X
		...
		if (GetKeyboardPress(DIK_LEFT) || IsButtonPressed(LSTICK_LEFT))  sense->x -= 0.1f;
		if (GetKeyboardPress(DIK_RIGHT) || IsButtonPressed(LSTICK_RIGHT)) sense->x += 0.1f;
	...
	{// 感度Y
		...
		if (GetKeyboardPress(DIK_LEFT) || IsButtonPressed(LSTICK_LEFT))  sense->y -= 0.1f;
		if (GetKeyboardPress(DIK_RIGHT) || IsButtonPressed(LSTICK_RIGHT)) sense->y += 0.1f;
	...
	{// 補正
		...
		if (GetKeyboardPress(DIK_LEFT)  || IsButtonPressed(LSTICK_LEFT) )  *correct -= 0.1f;
		if (GetKeyboardPress(DIK_RIGHT) || IsButtonPressed(LSTICK_RIGHT)) *correct += 0.1f;
